...
var ASM_CONSTS = {
  4812548: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4812603: function($0) {performance.now = function() { return $0; };},  
 4812651: function($0) {performance.now = function() { return $0; };},  
 4812699: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4812754: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4812815: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4812879: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  var state = {url:null,ws:null,debug:false,onOpen:null,onMessage:null,onError:null,onClose:null};
